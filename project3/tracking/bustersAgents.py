...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distribution in livingGhostPositionDistributions:
            distributionMax.append(distribution.argMax())
                        
        goalPos = None
        goalDis = None
        for position in distributionMax:
        ...
        for action in legal:
            ...
            successorDis = self.distancer.getDistance(successorPos, goalPos)
            actions.append((action, successorDis))
